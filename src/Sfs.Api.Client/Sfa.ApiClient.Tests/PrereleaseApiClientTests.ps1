$packages="SFA.Roatp.Api.Client","SFA.DAS.Apprenticeships.Api.Client","SFA.DAS.AssessmentOrgs.Api.Client","SFA.DAS.Providers.Api.Client"
$a = Get-Date
foreach ($package in $packages) 
{
Write-Host "Finding available versions for package - " $package
$providerapiversions = Find-Package -Name $package -Source https://nuget.org/api/v2/ -AllVersions | Select-Object -property Version | Where-Object {$_.Version -like "*prerelease*"} |  Select-Object -first 1
